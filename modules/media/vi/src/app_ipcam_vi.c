...
#endif
#ifdef SENSOR_OV_OS08C10
    case OV_OS08C10_MIPI_2M_60FPS_10BIT_WDR2TO1:
    case OV_OS08C10_MIPI_1M_120FPS_10BIT_WDR2TO1:
        return &stSnsOs08c10_Obj;
#endif
#ifdef PICO_384
...
CVI_S32 app_ipcam_Isp_PubAttr_Get(SAMPLE_SNS_TYPE_E enSnsType, ISP_PUB_ATTR_S *pstIspPubAttr)
{
    ...
    case GCORE_GC4683_MIPI_4M_60FPS_10BIT:
        ...
        break;
    case GCORE_GC4683_MIPI_1M_120FPS_10BIT:
        pstIspPubAttr->f32FrameRate = 120;
        break;
    default:
...
int app_ipcam_Vi_Isp_Init(void)
{
    ...
    for (CVI_U32 i = 0; i < g_pstViCtx->u32WorkSnsCnt; i++) {
        ...
        CVI_S32 u32TEAISPMode = 0;
        /* isp not support multi sensor now */
        // if (g_pstViCtx->u32WorkSnsCnt > 1) {
        //     u32TEAISPMode = TEAISP_AFTER_FE_RAW_MODE;
        //     s32Ret = CVI_TEAISP_SetMode(ViPipe, u32TEAISPMode);
        //     APP_IPCAM_CHECK_RET(s32Ret, "CVI_ISP_SetTEAISPMode fail, ViPipe[%d]\n", ViPipe);
        // }
        if (g_pstViCtx->u32WorkSnsCnt == 1) {
