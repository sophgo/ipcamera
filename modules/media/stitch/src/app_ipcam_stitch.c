...
static CVI_S32 app_ipcam_stitch_proc()
{
    ...
    while (g_Stitch_Running) {
        ...
        for (int i = 0; i < (int)g_pstStitchCfg->srcNum; i++){
            ...
            s32Ret = CVI_STITCH_SendFrame(g_pstStitchCfg->grpId,
                (STITCH_SRC_IDX) i,
...
CVI_S32 app_ipcam_Stitch_UnInit(void)
{
    ...
    if (Enable) {
        ...
        s32Ret = CVI_STITCH_DisableGrp(g_pstStitchCfg->grpId);
        if (s32Ret != CVI_SUCCESS) {
...
CVI_S32 app_ipcam_Stitch_Init(void)
{
    ...
    if (Enable) {
        ...
        s32Ret = CVI_STITCH_InitGrp(g_pstStitchCfg->grpId);
        if (s32Ret != CVI_SUCCESS) {
        ...
        s32Ret = CVI_STITCH_SetSrcAttr(g_pstStitchCfg->grpId, &g_pstStitchCfg->srcAttr);
        if (s32Ret != CVI_SUCCESS) {
        ...
        s32Ret = CVI_STITCH_SetChnAttr(g_pstStitchCfg->grpId, &g_pstStitchCfg->chnAttr);
        if (s32Ret != CVI_SUCCESS) {
        ...
        s32Ret = CVI_STITCH_SetOpAttr(g_pstStitchCfg->grpId, &g_pstStitchCfg->opAttr);
        if (s32Ret != CVI_SUCCESS) {
        ...
        s32Ret = CVI_STITCH_SetWgtAttr(g_pstStitchCfg->grpId, &g_pstStitchCfg->wgtAttr);
        if (s32Ret != CVI_SUCCESS) {
        ...
        s32Ret = CVI_STITCH_EnableGrp(g_pstStitchCfg->grpId);
        if (s32Ret != CVI_SUCCESS) {
        ...
        if (g_pstStitchCfg->bAttachEn) {
            s32Ret = CVI_STITCH_AttachVbPool(g_pstStitchCfg->grpId, (VB_POOL)g_pstStitchCfg->u32AttachVbPool);
            if (s32Ret != CVI_SUCCESS) {
...
STITCH_EXIT2:
    CVI_STITCH_DisableGrp(g_pstStitchCfg->grpId);
STITCH_EXIT1:
    CVI_STITCH_DeInit();
