...
typedef struct PANEL_DESC_S {
    CVI_CHAR *pchPanelName;
    PANEL_TYPE_E enPanelType;
    struct combo_dev_cfg_s *pstDevCfg;
    struct hs_settle_s *pstHsTimingCfg;
    struct dsc_instr *pstDsiInitCmds;
    CVI_S32 s32DsiInitCmdsSize;
} PANEL_DESC_T;

typedef enum _PANEL_NAME_E {
...
CVI_S32 app_ipcam_Panel_PanelDesc_Get(const PANEL_NAME_E* const pstPanelName, \
