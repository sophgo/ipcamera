...
__attribute__((weak)) int Load_Param_Dpu(const char *file)
{
    APP_PROF_LOG_PRINT(LEVEL_INFO, "%s defalut param \r\n", __func__);
    return 0;
}
...
const char *vb_source[VB_SOURCE_BUTT] = {
    [VB_SOURCE_COMMON] = "VB_SOURCE_COMMON",
    [VB_SOURCE_MODULE] ="VB_SOURCE_MODULE",
    [VB_SOURCE_PRIVATE] = "VB_SOURCE_PRIVATE",
    [VB_SOURCE_USER] = "VB_SOURCE_USER"
};
