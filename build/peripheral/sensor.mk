ifeq ($(CONFIG_SENSOR_CVSENS_CV2003), y)
    KBUILD_DEFINES += -DSNS0_CVSENS_CV2003
endif

ifeq ($(CONFIG_SENSOR_CVSENS_CV2003_1L_SLAVE), y)
    KBUILD_DEFINES += -DSNS0_CVSENS_CV2003_1L_SLAVE
endif

ifeq ($(CONFIG_SENSOR_CVSENS_CV2003_1L_SLAVE1), y)
    KBUILD_DEFINES += -DSNS0_CVSENS_CV2003_1L_SLAVE1
endif

ifeq ($(CONFIG_SENSOR_CVSENS_CV4001), y)
    KBUILD_DEFINES += -DSNS0_CVSENS_CV4001
endif
...
ifeq ($(CONFIG_SENSOR_GCORE_GC1084), y)
    KBUILD_DEFINES += -DSNS0_GCORE_GC1084
endif

ifeq ($(CONFIG_SENSOR_GCORE_GC1084_SLAVE), y)
    KBUILD_DEFINES += -DSNS1_GCORE_GC1084_SLAVE
endif

ifeq ($(CONFIG_SENSOR_GCORE_GC1084_SLAVE1), y)
    KBUILD_DEFINES += -DSNS1_GCORE_GC1084_SLAVE1
endif

ifeq ($(CONFIG_SENSOR_GCORE_GC1084_SLAVE2), y)
    KBUILD_DEFINES += -DSNS1_GCORE_GC1084_SLAVE2
endif
...
ifeq ($(CONFIG_SENSOR_OV_OS04E10), y)
    KBUILD_DEFINES += -DSNS0_OV_OS04E10
endif

ifeq ($(CONFIG_SENSOR_OV_OS05A20), y)
    KBUILD_DEFINES += -DSNS0_OV_OS05A20
endif

ifeq ($(CONFIG_SENSOR_OV_OS04E10_SLAVE), y)
    KBUILD_DEFINES += -DSNS0_OV_OS04E10_SLAVE
endif
...
ifeq ($(CONFIG_SENSOR_OV_OV9282), y)
    KBUILD_DEFINES += -DSNS0_OV_OV9282
endif

ifeq ($(CONFIG_SENSOR_OV_OV9282_SLAVE), y)
    KBUILD_DEFINES += -DSNS0_OV_OV9282_SLAVE
endif
...
ifeq ($(CONFIG_SENSOR_SMS_SC1330), y)
    KBUILD_DEFINES += -DSNS0_SMS_SC1330
endif

ifeq ($(CONFIG_SENSOR_SMS_SC1330_SLAVE), y)
    KBUILD_DEFINES += -DSNS0_SMS_SC1330_SLAVE
endif

ifeq ($(CONFIG_SENSOR_SMS_SC1330_1L), y)
    KBUILD_DEFINES += -DSNS0_SMS_SC1330_1L
endif

ifeq ($(CONFIG_SENSOR_SMS_SC1330_1L_SLAVE), y)
    KBUILD_DEFINES += -DSNS0_SMS_SC1330_1L_SLAVE
endif
...
ifeq ($(CONFIG_SENSOR_SMS_SC2331_1L_SLAVE), y)
    KBUILD_DEFINES += -DSNS1_SMS_SC2331_1L_SLAVE
endif

ifeq ($(CONFIG_SENSOR_SMS_SC2331_1L_SLAVE1), y)
    KBUILD_DEFINES += -DSNS2_SMS_SC2331_1L_SLAVE1
endif
...
ifeq ($(CONFIG_SENSOR_SMS_SC2336_SLAVE), y)
    KBUILD_DEFINES += -DSNS1_SMS_SC2336_SLAVE
endif

ifeq ($(CONFIG_SENSOR_SMS_SC2336_SLAVE1), y)
    KBUILD_DEFINES += -DSNS2_SMS_SC2336_SLAVE1
endif
...
ifeq ($(CONFIG_SENSOR_SMS_SC2336P_1L), y)
    KBUILD_DEFINES += -DSNS0_SMS_SC2336P_1L
endif
...
ifeq ($(CONFIG_SENSOR_SMS_SC4336P_SLAVE), y)
    KBUILD_DEFINES += -DSNS0_SMS_SC4336P_SLAVE
endif
...
ifeq ($(CONFIG_SENSOR_SMS_SC3336_1L), y)
    KBUILD_DEFINES += -DSNS0_SMS_SC3336_1L
endif

ifeq ($(CONFIG_SENSOR_SMS_SC3336_1L_SLAVE), y)
    KBUILD_DEFINES += -DSNS0_SMS_SC3336_1L_SLAVE
endif
...
ifeq ($(CONFIG_SENSOR_SMS_SC438AI), y)
    KBUILD_DEFINES += -DSNS0_SMS_SC438AI
endif

ifeq ($(CONFIG_SENSOR_SMS_SC438AI_SLAVE), y)
    KBUILD_DEFINES += -DSNS0_SMS_SC438AI_SLAVE
endif
