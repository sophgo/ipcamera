...
INCS-$(CONFIG_MODULE_AI) += -I$(TDL_PATH)/install/SOPHON/include
INCS-$(CONFIG_MODULE_AI) += -I$(TDL_PATH)/install/SOPHON/include/c_apis
...
#RTSP
INCS-$(CONFIG_MODULE_RTSP)    += -I$(APP_COMPONENTS_DIR)/comps_install/$(TARGET_MACHINE)/rtsp/include
INCS-$(CONFIG_MODULE_RTSP)    += -I$(APP_COMPONENTS_DIR)/comps_install/$(TARGET_MACHINE)/ringbuffer/include
INCS-$(CONFIG_MODULE_RTSP)    += -I$(APP_COMPONENTS_DIR)/comps_install/$(TARGET_MACHINE)/osal/include
