...
#OSAL
CVI_OSAL_DIR = $(APP_COMPONENTS_DIR)/comps_install/$(TARGET_MACHINE)/osal
#RINGBUFFER
RINGBUFFER_DIR = $(APP_COMPONENTS_DIR)/comps_install/$(TARGET_MACHINE)/ringbuffer
#RTSP
CVI_RTSP_DIR = $(APP_COMPONENTS_DIR)/comps_install/$(TARGET_MACHINE)/rtsp
#MBUF
